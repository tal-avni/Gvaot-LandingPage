export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <nav className="fixed top-0 right-0 left-0 z-50 flex items-center justify-between px-6 py-4 bg-[#3730a3]/80 backdrop-blur-sm border-b border-white/10">
        <img src="/logo-blue.png" alt="גבעות" className="h-16 w-auto object-contain" />
        <button
